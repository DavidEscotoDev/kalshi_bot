...
class RiskManager:
    ...
    def calculate_kelly_fraction(
        self, estimated_prob: Decimal, market_price: Decimal, side: str
    ) -> Decimal:
        """
    ...
    def get_max_allowed_wager_for_sector(
        self, sector: str, current_sector_exposure: Decimal, total_capital: Decimal
    ) -> Decimal:
        """
    ...
    def size_order(
        ...
        max_allowed_for_sector = self.get_max_allowed_wager_for_sector(
            sector, current_sector_exposure, total_capital
        )
